<%-- 
    Document   : Bill
    Created on : Mar 15, 2023, 12:30:39 PM
    Author     : Acer
--%>
    ...
    <body>
        ...
        <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 drop-shadow-lg shadow-black" aria-label="Sidebar">
            <div class="h-full w-full px-3 py-4 pt-20 flex flex-col justify-between overflow-y-auto bg-gray-100 dark:bg-gray-800">
                ...
                <form action="">
                    <button type="button" class="flex items-center justify-center text-center w-full px-3 py-2 text-sm font-medium text-blue-900 bg-blue-300 rounded-lg dark:bg-blue-700 dark:text-blue-100 hover:bg-blue-400 dark:hover:bg-blue-800">Logout</button>
                </form>
            </div>
        </aside>
        ...
        <div class="ml-64 pt-16 h-screen flex items-center justify-center">
            <div class="w-full h-full p-10">
                <div class="w-full h-full">
                    <div class="flex">
                        <div class="w-1/2">
                            <h1 class="font-bold text-3xl text-gray-900 pb-1 mb-8 border-b-2 border-blue-700 inline-block">Electricity water usage</h1>
                            <table>
                                <tr>
                                    <th>StudentID</th>
                                    <th>RoomID</th>
